...
##
golem::fill_desc(
  pkg_name = "biographr", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
...
golem::use_favicon("scatter_plot.ico") # path = "path/to/ico". Can be an online file.
