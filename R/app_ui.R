					...
					shinydashboard::tabItem(
						...
						shiny::fluidRow(
							shiny::column(
								width = 4,
								shinydashboard::box(
									title = "Open a dataset", status = "primary",
							...
							shiny::column(
								width = 8,
								shinydashboard::box(
									title = "Data summary", status = "primary",
									solidHeader = TRUE, width = NULL,
					...
					shinydashboard::tabItem(
						...
						shiny::fluidRow(
							shiny::column(
								width = 3,
								shinydashboard::box(
									title = "Statistics", status = "primary",
									solidHeader = TRUE, width = NULL,
								...
								shinydashboard::box(
									...
									shiny::conditionalPanel(
										"input.stat == 'freq' || input.stat == 'xs1' || input.stat == 'xs2'",
										shinyjqui::orderInput("change_v1", "Drag and drop values to reorder", items = "")
									),
									shiny::conditionalPanel(
										"input.stat != 't1' && input.stat != 'xs1'",
								...
								shinydashboard::box(
									...
									shiny::conditionalPanel(
										"input.stat == 'anova' || input.stat == 'regr'",
							...
							shiny::column(
								width = 8,
								shinydashboard::box(
									title = "Statistics results", width = NULL,
									status = "primary", solidHeader = TRUE,
					...
					shinydashboard::tabItem(
						...
						shiny::fluidRow(
							shiny::column(
								width = 12,
								shinydashboard::box(
									title = "Using the app", status = "primary",
									solidHeader = TRUE, width = NULL,
